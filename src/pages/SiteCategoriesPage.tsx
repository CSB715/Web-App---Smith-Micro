...
import { Button, Box, Typography, CircularProgress, List, ListItem, ListItemButton, IconButton } from "@mui/material";
...
function SiteCategories() {
  ...
  return (
    ...
    >
      ...
      />
      <AddSiteModal isOpen={modalOpen} closeModal={() => {setModalOpen(false)}} 
